                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Authors
                                        Earnings</span>
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">More
                                        than 400+ new members</span>
                                </h3>
                                <div class="card-toolbar">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pl-0">
                                                            <a href="#"
                                                                ...
                                                                Wayde</a>
                                                            <span class="text-muted font-weight-bold d-block">ReactJS
                                                                Developer</span>
                                                        </td>
                                                        <td></td>
                                                        <td class="text-right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pl-0">
                                                            <a href="#"
                                                                ...
                                                                Trump</a>
                                                            <span class="text-muted font-weight-bold d-block">UI/UX
                                                                Designer</span>
                                                        </td>
                                                        <td></td>
                                                        <td class="text-right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pl-0">
                                                            <a href="#"
                                                                ...
                                                                Leonard</a>
                                                            <span class="text-muted font-weight-bold d-block">Art
                                                                Director</span>
                                                        </td>
                                                        <td></td>
                                                        <td class="text-right">
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#"
                                            ...
                                            &amp; Green</a>
                                        <span class="text-muted font-weight-bold font-size-sm my-1">Local,
                                            clean &amp; environmental</span>
                                        <span class="text-muted font-weight-bold font-size-sm">Created
                                            by:
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#"
                                            ...
                                            Background</a>
                                        <span class="text-muted font-weight-bold font-size-sm my-1">Strong
                                            abstract concept</span>
                                        <span class="text-muted font-weight-bold font-size-sm">Created
                                            by:
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pr-3">
                                        <a href="#"
                                            ...
                                            &amp; Blue</a>
                                        <span class="text-muted font-weight-bold font-size-sm my-1">Footwear
                                            overalls</span>
                                        <span class="text-muted font-weight-bold font-size-sm">Created
                                            by:
                                            <span class="text-primary font-weight-bold">Invision
                                                Inc.</span></span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Info-->
                                ...
                                <div class="d-flex flex-wrap align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#"
                                            ...
                                            platter</a>
                                        <span class="text-muted font-size-sm font-weight-bold my-1">Food
                                            trends &amp; reviews</span>
                                        <span class="text-muted font-size-sm font-weight-bold">Created
                                            by:
                                            <span class="text-primary font-weight-bold">Figma
                                                Studio</span></span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Info-->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="assets/media/logos/stars.png" alt="image"
                                                            style="width: 5rem" />
                                                        <span class="text-muted font-weight-bold d-block">Above
                                                            Average</span>
                                                    </td>
                                                    <td class="pr-0 text-right">
                                                        <a href="#"
                ...
                <div class="row">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                                            ...
                                            <div class="d-flex flex-column align-items-cente py-2 w-75">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Data-->
                                                <span class="text-muted font-weight-bold">Due in 2
                                                    Days</span>
                                                <!--end::Data-->
                                            </div>
                                            <!--end::Info-->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Trending
                                        Items</span>
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">More
                                        than 400+ new members</span>
                                </h3>
