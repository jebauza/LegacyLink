                    ...
                    <div class="aside-menu-wrapper flex-column-fluid px-3 px-lg-10 py-5" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1"
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item @if(Route::is('admin.office.indexView')) menu-item-active @endif"
                                    aria-haspopup="true">
                                    <a href="{{ route('admin.office.indexView') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">

                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-03-11-144509/theme/html/demo3/dist/../src/media/svg/icons/Home/Building.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
