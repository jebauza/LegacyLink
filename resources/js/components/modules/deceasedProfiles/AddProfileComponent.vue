<template>
<div class="modal fade" id="modalAddDeceasedProfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
                            ...
                            <div class="tab-pane" id="kt_tab_client" role="tabpanel">
                                <div class="row">
                                    <div class="form-group col-auto">
                                        <vs-switch success v-model="loadClient.switch">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-sm-8 col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <vs-tooltip bottom>
                                                    <vs-switch class="mt-9" color="primary" v-model="form.client_sendSms">
                                                        <template #circle>
                                                            <i v-if="form.client_sendSms" class='fas fa-comment-dots' ></i>
                                                            <i v-else class='fas fa-comment-slash' ></i>
                                                        </template>
                                                    </vs-switch>
                                                    <template #tooltip>
                                                        Enviar SMS con link de acceso para la administración
                                                    </template>
                                                </vs-tooltip>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input  v-model="form.client_email" type="email" :class="['form-control', errors.client_email ? 'is-invalid' : '']" name="client_email" :placeholder="__('validation.attributes.email')" :disabled="loadClient.switch">
                                            ...
                                            <div class="col-auto">
                                                <vs-tooltip bottom>
                                                    <vs-switch class="mt-9" color="primary" v-model="form.client_sendEmail">
                                                        <template #circle>
                                                            <i v-if="!form.client_sendEmail" class='fas fa-envelope' ></i>
                                                            <i v-else class='fas fa-envelope-open-text' ></i>
                                                        </template>
                                                    </vs-switch>
                                                    <template #tooltip>
                                                        Enviar correo con link de acceso para la administración
                                                    </template>
                                                </vs-tooltip>
                                            </div>
                                        </div>
...
export default {
    watch: {
        ...
        'loadClient.switch': function (newValue, oldValue) {
            if (!newValue) {
                this.loadClient = {
                    switch: false,
                    search: '',
    ...
    methods: {
        ...
        getAdvisers() {
            const url = `/admin/ajax/employees?role=2-3&office=${this.form.dprofile_office}`;
        ...
        store() {
            ...
            .then(res => {
                ...
                $('#modalAddDeceasedProfile').modal('hide');
                this.clearForm();
